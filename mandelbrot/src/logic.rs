...
pub fn generate_mandelbrot_set( 
    ...
    let canvas_w_64 =canvas_w as f64;
    let canvas_h_64 = canvas_h as f64;

    let mut data = vec![];
    for i in 0..canvas_h{
        let i_f64 = i as f64;
        let y = y_min + (y_max - y_min) * i_f64 as f64 /  canvas_h_64;
        for j in 0..canvas_w{
            let x = x_min + (x_max - x_min) * j as f64/canvas_w_64;
